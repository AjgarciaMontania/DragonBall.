  ...
  return (
    <div className={`dragonball-card ${getBorderClass()} ${isDetailPage ? 'super-saiyan-effect' : ''}`}>
      ...
      <div className="card-content">
        ...
        <div className="character-stat">
          <span className="stat-label ki-label">Base KI:  </span>
        </div>
          <span className="stat-value">{character.ki || '???'}</span>
        <div className="character-stat">
          <span className="stat-label ki-label">Total KI:</span>
        </div>
          <span className="stat-value">{character.maxKi || '???'}</span>
        <div className="character-stat">
          <span className="stat-label affiliation-label">Affiliation:</span>
        </div>
          <span className="stat-value">{character.affiliation || 'Desconocida'}</span>
      </div>
    </div>
  );
};
